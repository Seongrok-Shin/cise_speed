  ...
  return (
    <>
      ...
      <div className="overflow-hidden">
        ...
        <div className="absolute mobile:top-[300px] tablet:top-[400px] laptop:top-[400px] desktop:top-[500px] inset-x-0 flex-row flex justify-center font-sans text-center text-white ">
